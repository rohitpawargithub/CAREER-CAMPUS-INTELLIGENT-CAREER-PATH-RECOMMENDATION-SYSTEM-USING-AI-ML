<head>
	...
	<body>
		...
		<!--Header-->
        <header id="header" class="transparent-nav" style="position: fixed;background-color: rgba(182, 4, 87, 0.82); top: 0;">
			<div class="container">

				<div class="navbar-header">
					<!-- Logo -->
					<div class="navbar-brand">
						<a class="logo" href="main.php">Career Campus</a>
					</div>
					<!-- /Logo -->
				...
				<nav id="nav">
					<ul class="main-menu nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            <a class="dropbtn" href="#">Services <span>&#11167;</span></a>
