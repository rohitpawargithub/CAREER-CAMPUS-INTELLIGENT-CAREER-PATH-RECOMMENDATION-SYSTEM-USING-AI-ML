...
<?php include 'header.php'?>
		...
		<div id="home" class="hero-area">
			...
			<!-- Backgound Image -->
			<div class="bg-image bg-parallax overlay" style="background-image:url(./img/bg.png); width:100%; height: 656px;"></div>
			<!-- /Backgound Image -->
				...
				<div class="container">
					<div class="row">
						<div class="col-md-8">
							...
							<h1 class="white-text" style="font-size: 50px;margin-top: 20px;
							...
							<?php
								...
								<?php else: ?>
									...
									<a class="main-button icon-button" href="http://localhost:5000/predict">Get Started!</a>
			...
			<div class="container">
				...
				<div class="row">
					<div class="section-header text-center">
						...
						<h2 style="margin-top: 100px; font-size: 45px;">Welcome to Career Campus</h2>
						...
						<p class="lead"><b style="color: rgb(56, 48, 48);">Career Campus</b> is one stop destination <br>in helping you understand yourself, the best career for you <br> and providing all the resources in the process.</p>
					</div>
				</div>	
					...
					<div class="col-md-4">
						<div class="feature">
							...
							<div class="feature-content">
								...
								<?php else: ?>
									<a href="/predict"><h4>Career Prediction</h4></a>
